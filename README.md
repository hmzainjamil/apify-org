...
> Apify organization tools and actor management
...
| Integration — Claude Code + org connectivity | Integration layer — connecting to external tools and APIs | [docs](#) |
...
Use apify-org to automate apify organization tools and actor management. Perfect for agencies, freelancers, and AI-first teams running apify workflows at scale.
...
```bash
# Add to CLAUDE.md
echo "Auto-activate: apify, org" >> ~/.claude/CLAUDE.md

# Or load skill directly
/load-skill apify-org
```
...
{
  "hooks": {
    "PostToolUse": [{"matcher": "apify", "command": "python3 ~/repos/apify-org/main.py"}]
  }
}
```
...
```bash
# Fork and clone
gh repo fork hmzainjamil/apify-org --clone
cd apify-org
